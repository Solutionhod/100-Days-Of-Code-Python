...
window.config(bg=BG, padx=20, pady=50)

heading = Label(text=heading, font=HEAD_FONT, 
                bg=BG, fg=FG, padx=10, pady=20)
...
reset_btn = Button(text='Reset', fg='black', bg=BG, 
                   font=PARA_FONT, 
                   highlightbackground=FG, 
                   highlightcolor=FG, 
                   highlightthickness=0, border=3, 
                   command=reset_app, width=50, height=3, 
                   padx=10, pady=10)

save_btn = Button(text='Save', fg='black', bg=BG, 
                  font=PARA_FONT, 
                  highlightbackground=FG, 
                  highlightcolor=FG, 
                  highlightthickness=0, border=3, 
                  command=save_text, width=50, height=3, 
                  padx=10, pady=10)

heading.grid(row=0, column=0, columnspan=3)
instruction.grid(row=2, column=0, columnspan=3)
typing_area.grid(row=3, column=0, columnspan=3)
reset_btn.grid(row=4, column=0, rowspan=2)
save_btn.grid(row=4, column=2, rowspan=2)
